export const createStyles = (globalState) => {
  const {
    fontColor,
    fontSizeAdjustment,
    lineHeight,
  ...
  return `
    ...
    *{
    ...
    h1,h2,h3,h4,h5,h6 {
        ${highlightTitles
      ? `border:solid 2px black !important; background-color: ${titleBackgroundColor ? titleBackgroundColor : 'white'
      } !important; color:${fontColor ? fontColor : 'black'
      } !important;`
      : ''
    }
